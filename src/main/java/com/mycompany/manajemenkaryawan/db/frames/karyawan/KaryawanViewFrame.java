...
public class KaryawanViewFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cariButton.setForeground(new java.awt.Color(0, 0, 204));
        ...
        viewTable.setForeground(new java.awt.Color(0, 0, 102));
        viewTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id_karyawan", "Tanggal Lahir", "Nama Depan", "Nama Belakang", "gender", "Tanggal Masuk"
            }
        ) {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cariTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 542, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void cariButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariButtonActionPerformed
        try {
            ...
            String selectSQL = "SELECT * FROM karyawan WHERE nama_depan like '%"+kataKunci+"%' ";
            ...
            while(resultSet.next()){
                ...
                row[1] = resultSet.getString("tanggal_lahir");
                row[2] = resultSet.getString("nama_depan");
                row[3] = resultSet.getString("nama_belakang");
                row[4] = resultSet.getString("gender");
                row[5] = resultSet.getString("tanggal_masuk");
                model.addRow(row);
            }
            koneksi.close();
    ...
    private void ubahButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ubahButtonActionPerformed
                ...
                if(barisTerpilih >= 0){
                        ...
                        KaryawanAddFrame f = new KaryawanAddFrame(id_karyawan);
                        f.setVisible(true);
                    }else{
        ...
        if(barisTerpilih >= 0){
            ...
            if(pilihan == 0){
                try {
                    ...
                    int id_karyawan = (int) model.getValueAt(barisTerpilih, 0);
                    Connection koneksi = Basisdata.getConnection();
                    String deleteSQL = "DELETE FROM karyawan WHERE id_karyawan="+id_karyawan;
                    Statement statement = koneksi.createStatement();
